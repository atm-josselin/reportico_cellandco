...
define('SW_PROJECT_TITLE', 'PJ1706-IFC-139 IFCT-1701 DICIPLE');
...
define('SW_DB_USER', 'ext_dolibar');
define('SW_DB_PASSWORD', 'Q6aq9DfIf0lsqcc0');
define('SW_DB_HOST', '127.0.0.1');
define('SW_DB_DATABASE', 'dolibarr');
}
